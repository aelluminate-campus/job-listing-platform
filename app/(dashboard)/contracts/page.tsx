        ...
        <Card>
          <CardContent>
            <Table>
              <thead>
                <tr>
                  <th className="text-center">Title</th> {/* Centered Title */}
                  <th className="text-center">Company</th>
                  <th className="text-center">Start Date</th>
                  <th className="text-center">End Date</th>
                  <th className="text-center">Actions</th> {/* Center Actions */}
                </tr>
              </thead>
              <tbody>
                {contracts.map((contract) => (
                  <tr key={contract.id}>
                    <td className="text-center">{contract.title}</td> {/* Centered Title in Table Body */}
